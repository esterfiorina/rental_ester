...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>Rentester Car | Admin Edit Booking Car</title>
										...
										<div class="panel-body">
											...
											<form method="post" class="form-horizontal" name="theform" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="telp" class="form-control" value="<?php echo $result['telp']; ?>"
															required readonly>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<a href="../image/bukti/<?php echo $result['bukti_bayar']; ?>" target="_blank"><img
																src="../image/bukti/<?php echo $result['bukti_bayar']; ?>" width="150" height="150"></a>
													</div>
												</div>
												<div class="form-group">
													<div class="col-sm-3">
														<div class="checkbox checkbox-inline">
															<button class="btn btn-primary" type="submit" name="submit" style="margin-top:4%">Save
																changes</button>
														</div>
													</div>
												</div>
										...
										<div class="panel-body">
											<form>
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="driver" class="form-control"
															value="<?php echo format_rupiah($result['driver']); ?>" required readonly>
													</div>
												</div>
												<br />
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="mulai" class="form-control"
															value="<?php echo IndonesiaTgl($result['tgl_mulai']); ?>" required readonly>
													</div>
												</div>
												<br />
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="biayamobil" class="form-control"
															value="<?php echo format_rupiah($biayamobil); ?>" required readonly>
													</div>
												</div>
												<br />
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="selesai" class="form-control"
															value="<?php echo IndonesiaTgl($result['tgl_selesai']); ?>" required readonly>
													</div>
												</div>
												<br />
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="durasi" class="form-control" value="<?php echo $result['durasi']; ?>"
															required readonly>
													</div>
												</div>
											</form>
