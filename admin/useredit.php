...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>Rentester Car Portal | Admin Edit Data User</title>
								...
								<div class="col-md-12">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											?>
											<form method="post" class="form-horizontal" name="theform" action="usereditact.php"
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														...
														<input type="text" name="nama" class="form-control"
															value="<?php echo htmlentities($result['nama_user']); ?>" required>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="number" name="telp" min="0" class="form-control"
															value="<?php echo htmlentities($result['telp']); ?>" required>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<textarea class="form-control" name="alamat" rows="5"
															required><?php echo htmlentities($result['alamat']); ?></textarea>
													</div>
												</div>
												<div class="form-group">
