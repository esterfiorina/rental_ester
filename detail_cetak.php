		...
		<div class="container-fluid">
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td class="text-center">Jl. Raya Cibarusah No.11, RT.08/RW.01, Kec. Cibarusah, Kota Bekasi, Jawa Barat 17340
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						...
						<td>:</td>
						<td>
							<?php echo $result['nama_merek'];
							echo ", ";
							echo $result['nama_mobil']; ?>
						</td>
					</tr>
					<tr>
						<td>Tanggal Mulai</td>
					...
					if ($result['status'] == "Menunggu Pembayaran") {
						...
						<tr>
							<td colspan='3'>
								<b>*Silahkan transfer total biaya sewa ke " . $resultrek['detail'] . "maksimal tanggal " ?>
